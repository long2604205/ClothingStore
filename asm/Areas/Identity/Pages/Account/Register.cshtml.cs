        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.File != null && Input.File.Length > 0)
                {
                    ...
                    string imagePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "uploads", "avatars", Input.File.FileName);
                    ...
                    user.Image = "~/uploads/avatars/" + Input.File.FileName;
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    // Tắt xác nhận email và đăng nhập người dùng tự động
                    // await _signInManager.SignInAsync(user, isPersistent: false);
                    // return LocalRedirect(returnUrl);

                    TempData["SuccessMessage"] = "Sign up successfully";
                    TempData["Types"] = "success";

                    ViewData["SuccessMessage"] = TempData["SuccessMessage"];
                    ViewData["Type"] = TempData["Types"];
